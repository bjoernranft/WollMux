...
public class GuiFactory
{
   ...
   */
  public static XControl createControlContainer(XMultiComponentFactory xMCF, XComponentContext context,
      XToolkit toolkit, XWindowPeer windowPeer, Rectangle size, SortedMap<String, Object> props)
  {
    return createControl(xMCF, context, toolkit, windowPeer, UnoComponent.CSS_AWT_UNO_CONTROL_CONTAINER, props, size);
  }
